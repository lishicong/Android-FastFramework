...
import com.fast.framework.style.skin.view.SkinnableButton;
import com.fast.framework.style.skin.view.SkinnableFrameLayout;
import com.fast.framework.style.skin.view.SkinnableLinearLayout;
import com.fast.framework.style.skin.view.SkinnableRelativeLayout;
import com.fast.framework.style.skin.view.SkinnableTextView;
import com.fast.framework.style.skin.view.SkinnableToolbar;

class SkinnableViewInflater {
    ...
    public final View createView(View parent, final String name, @NonNull Context context, @NonNull AttributeSet attrs,
                                 boolean inheritContext, boolean readAndroidTheme, boolean readAppTheme,
                                 boolean wrapContext) {
