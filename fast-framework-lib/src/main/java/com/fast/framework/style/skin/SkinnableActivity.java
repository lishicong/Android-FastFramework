...
public class SkinnableActivity extends AppCompatActivity implements LayoutInflaterFactory {
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        return mSkinnableViewInflater.createView(parent, name, context, attrs, inheritContext, isPre21, /* Only read
        android:theme pre-L (L+ handles this anyway) */
                                                 true, /* Read read app:theme as a fallback at all times for legacy
                                                 reasons */
                                                 VectorEnabledTintResources.shouldBeUsed() /* Only tint wrap the
                                                 context if enabled */);
    }
