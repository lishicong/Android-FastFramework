...
public abstract class ScalableTextureView extends TextureView {
    ...
    private void updateMatrixScaleRotate() {
        ...
        mTransformMatrix.setScale(mContentScaleX * mContentScaleMultiplier, mContentScaleY * mContentScaleMultiplier,
                                  mPivotPointX, mPivotPointY);
    ...
    public float getContentAspectRatio() {
        return mContentWidth != null && mContentHeight != null ? (float) mContentWidth / (float) mContentHeight : 0;
    }
