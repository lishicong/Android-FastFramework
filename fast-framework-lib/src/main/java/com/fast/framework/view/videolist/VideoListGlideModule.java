...
public class VideoListGlideModule implements GlideModule {
    ...
    private static OkHttpClient sClient = new OkHttpClient.Builder().addNetworkInterceptor(
            createInterceptor(new DispatchingProgressListener())).build();
        ...
        return new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                return response.newBuilder().body(
                        new OkHttpProgressResponseBody(request.url(), response.body(), listener)).build();
            }
        };
    }
