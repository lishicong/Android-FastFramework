...
public class FastRadioButton extends RadioButton {
    ...
    private int mLeftWith, mLeftHeight, mTopWith, mTopHeight, mRightWith, mRightHeight, mBottomWith, mBottomHeight,
            mMarginLeft, mMarginTop, mMarginRight, mMarginBottom;
