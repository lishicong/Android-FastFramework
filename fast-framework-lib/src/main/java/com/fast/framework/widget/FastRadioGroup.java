 ...
 */
public class FastRadioGroup extends LinearLayout {
     ...
     * {@inheritDoc}
     */
    public FastRadioGroup(Context context) {
        super(context);
        init();
    }
     ...
     * {@inheritDoc}
     */
    public FastRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new FastRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof FastRadioGroup.LayoutParams;
    }
